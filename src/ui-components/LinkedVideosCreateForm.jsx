...
export default function LinkedVideosCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setVideo_code(initialValues.video_code);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new LinkedVideos(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LinkedVideosCreateForm")}
      {...rest}
    >
      <TextField
        label="Video code"
